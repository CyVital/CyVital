...
This file is a modified version based on dwfpy: https://github.com/mariusgreuel/dwfpy
"""
import time
import numpy as np
import dwfpy as dwf
...
# Create figure for plotting - removed the middle graph
...
time_values = []
peak_times = []
window_duration = 10  # seconds to calculate BPM over
